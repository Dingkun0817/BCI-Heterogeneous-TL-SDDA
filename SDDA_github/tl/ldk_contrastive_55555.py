...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        # total_loss = classifier_loss + ditillation_loss + alignment_loss2 + 2.0 * transfer_loss   # 2
        total_loss = classifier_loss + ditillation_loss + alignment_loss2 + 1.9 * transfer_loss
        # total_loss = classifier_loss + ditillation_loss
