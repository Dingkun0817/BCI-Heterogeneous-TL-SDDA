...
def mixup_data(X, y, alpha=0.2):
    num_samples, num_channels, num_points = X.shape
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        alignment_loss2 = mmd_rbf(features_source, features_target, kernel_mul=2.0, kernel_num=5, fix_sigma=None)
        ...
        ditillation_loss = distillation(outputs_source, labels_source, outputs_source_teacher, temp=6, alpha=0.5)   # 5  0.7
