...
from utils.utils_1 import fix_random_seed, cal_acc_comb, data_loader, cal_auc_comb, cal_score_online, cal_auc
...
def train_target(args):
    ...
    if args.balanced:
        ...
        auc_t_te, y_pred = ISFDA(dset_loaders["Target-Online-Imbalanced"], base_network, args=args, balanced=False)
