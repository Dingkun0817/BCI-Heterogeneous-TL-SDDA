...
def train_target(args):
    ...
    if args.balanced:
        ...
        acc_t_te, pre_t_te, rec_t_te, f1_t_te, y_pred = ISFDA(dset_loaders2["Target-Online-Imbalanced"], base_network, args=args, balanced=False)
...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(N1=N1, data_name1=dataset1,
                              ...
                              sample_rate=250, feature_deep_dim=248, trial_num=680,
