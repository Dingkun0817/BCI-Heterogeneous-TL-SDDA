...
from utils.utils_1 import lr_scheduler_full, fix_random_seed, cal_acc_comb, data_loader, cal_auc
...
def train_target(args):
    ...
    if args.max_epoch == 0:
        ...
        while iter_num < max_iter:
            ...
            if iter_num % interval_iter == 0 or iter_num == max_iter:
                ...
                # acc_t_te, pre_t_te, rec_t_te, f1_t_te, _ = cal_acc(dset_loaders["Target"], netF, netC, args=args)
                ...
                auc_t_te, _ = cal_auc(dset_loaders["Target"], netF, netC)
    ...
    while iter_num < max_iter:
        ...
        if iter_num % interval_iter == 0 or iter_num == max_iter:
            netF.eval()
            if args.paradigm == 'MI' or args.paradigm == 'P300':
                # acc_t_te, pre_t_te, rec_t_te, f1_t_te, y_pred = cal_acc(dset_loaders["Target"], netF, netC, args=args)
                auc_t_te, y_pred = cal_auc(dset_loaders["Target"], netF, netC)
                ...
                log_str = 'Task: {}, Iter:{}/{}; Auc = {:.2f}%'. \
                           format(args.task_str, int(iter_num // interval_iter), \
                           int(max_iter // interval_iter), auc_t_te)
            args.log.record(log_str)
            print(log_str)
            netF.train()
...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(N1=N1, data_name1=dataset1,
                              ...
                              class_num=2, chn=10, time_sample_num=206, layer='wn',
                              ...
                              smooth=0, threshold=0, distance='cosine', cov_type='oas', paradigm='P300')
