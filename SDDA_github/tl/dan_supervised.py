...
def train_target(args):
    ...
    '''
        len(dset_loaders["source"]是40, 1296/bs = 1296/32 = 40.5 = 40
        每个epoch需要走4个iter才能遍历1296个样本
        interval_iter好像就是当前的epoch轮数
    '''
    ...
    while iter_num < max_iter:
        ...
        # print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
        # print("alignment_weight is :  ", alignment_weight)
        # print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(N1=N1, data_name1=dataset1,
                              ...
                              class_num=2, chn=3, time_sample_num=1001,
